...
/**
 * Index frontend controller factory.
 *
 * @package Controller
 * @subpackage Frontend
 */
...
{
	/**
	 * Creates a new index controller object.
	 *
	...
	public static function createController( \Aimeos\MShop\Context\Item\Iface $context, $name = null )
	{
		 ...
		 *
		 *  \Aimeos\Controller\Frontend\Index\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Controller\Frontend\Index\Myindex
		 *
		 * then you have to set the this configuration option:
		 *
		 *  controller/jobs/frontend/index/name = Myindex
		 *
		 ...
		 *
		 *  controller/frontend/index/decorators/excludes = array( 'decorator1' )
		 *
		 * This would remove the decorator named "decorator1" from the list of
		 * common decorators ("\Aimeos\Controller\Frontend\Common\Decorator\*") added via
		 * "controller/frontend/common/decorators/default" for the index frontend controller.
		 *
		 ...
		 * @see controller/frontend/index/decorators/local
		 */

		/** controller/frontend/index/decorators/global
		 * Adds a list of globally available decorators only to the index frontend controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 *
		 *  controller/frontend/index/decorators/global = array( 'decorator1' )
		 *
		...
		/** controller/frontend/index/decorators/local
		 * Adds a list of local decorators only to the index frontend controllers
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * ("\Aimeos\Controller\Frontend\Index\Decorator\*") around the frontend controller.
		 *
		 *  controller/frontend/index/decorators/local = array( 'decorator2' )
		 *
		 * This would add the decorator named "decorator2" defined by
		 * "\Aimeos\Controller\Frontend\Index\Decorator\Decorator2" only to the frontend
		 * controller.
		 *
		 * @param array List of decorator names
		 * @since 2017.03
